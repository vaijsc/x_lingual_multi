...
PYTHONPATH=${BASE_PATH} python3 ${BASE_PATH}/reward_eval/reward_eval.py \
    ...
    --answer2_path ${BASE_PATH}/results/tinyllama2/eval_main/non_distill/self_inst/self_inst-512/stu/10/answers.jsonl \
    --load_data_answer_1 ${BASE_PATH}/eval_with_reward/self_inst/minillm.csv \
    --model_1_type_id minillm \
    --model_2_type_id non_distill \
    --data_name self_inst \
...
PYTHONPATH=${BASE_PATH} python3 ${BASE_PATH}/reward_eval/reward_eval.py \
    ...
    --answer2_path ${BASE_PATH}/results/tinyllama2/eval_main/non_distill/sinst_11_/sinst_11_-512/stu/10/answers.jsonl \
    --load_data_answer_1 ${BASE_PATH}/eval_with_reward/sinst/minillm.csv \
    --model_1_type_id minillm \
    --model_2_type_id non_distill \
    --data_name sinst \
...
PYTHONPATH=${BASE_PATH} python3 ${BASE_PATH}/reward_eval/reward_eval.py \
    ...
    --answer2_path ${BASE_PATH}/results/tinyllama2/eval_main/non_distill/vicuna/vicuna-512/stu/10/answers.jsonl \
    --model_1_type_id minillm \
    --model_2_type_id non_distill \
    --data_name vicuna \
