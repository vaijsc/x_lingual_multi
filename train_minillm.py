...
def get_teacher_model(args, device):
    ...
    if args.model_parallel:
        ...
        if args.teacher_int8:
            ...
            model = AutoModelForCausalLM.from_pretrained(args.teacher_model_path, config=config, device_map={"": device}, quantization_config=bnb_config)#, load_in_4bit=True, )#, torch_dtype=torch.bfloat16)
        ...
        if args.peft_teacher is not None and args.teacher_peft_path is not None:
            if args.peft_teacher == "lora":
