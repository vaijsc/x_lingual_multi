...
class LitNERAdapter(pl.LightningModule):
    def __init__(self, pretrained_ck: str, lang_adapter_ckpt: str, lr: float, model: str, lang: str):
        ...
        self.model = NERAdapterModel(config)
        self.num_labels = config.num_labels
        self.loss = nn.CrossEntropyLoss()
        self.lr = lr
        self.valid_metric = evaluate.load("metrics/seqeval.py")
