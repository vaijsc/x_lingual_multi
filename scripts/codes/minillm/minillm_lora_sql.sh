...
# teacher
TEACHER_CKPT="seeklhy/codes-15b-spider"
TEACHER_CKPT_NAME="codes-15b-spider"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/sql/prompt/codes/"
LM_DATA_DIR="${BASE_PATH}/processed_data/minipile/codes/4096/990K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/codes/train/minillm/v0"
# hp
GRAD_ACC=8
BATCH_SIZE=1
CHUNK_SIZE=4
...
# deepspeed
OPTS+=" --deepspeed"
OPTS+=" --deepspeed_config ${BASE_PATH}/configs/deepspeed/ds_config_zero3_offload.json"
