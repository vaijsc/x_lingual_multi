...
TEACHER_PEFT_CKPT_NAME="CodeS-15B"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/codes/train/teacher-sft/e1-bs1-lr0.0005-G8-N1-NN1-lora-16-64-0.1/8186"
# data
...
# runtime
SAVE_PATH="${BASE_PATH}/results/codes/train/gkd/v2"
# seed
SEED=10
