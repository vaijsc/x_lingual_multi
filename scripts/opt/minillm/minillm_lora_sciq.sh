...
PEFT_CKPT="${BASE_PATH}/results/opt/train/sciq/init/e3-bs8-lr0.0005-G1-N2-NN1-lora-16-64-0.1/2187" # directory point to init checkpoint
# teacher
TEACHER_CKPT_NAME="opt-7b"
TEACHER_CKPT="facebook/opt-6.7b"
TEACHER_PEFT_CKPT_NAME="opt-7b"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/opt/train/sciq/teacher-sft/e5-bs4-lr0.0005-G2-N2-NN1-lora-16-64-0.1/3645"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/sciq/prompt/opt/"
LM_DATA_DIR="${BASE_PATH}/processed_data/minipile/opt/1024/990K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/opt/train/sciq/minillm"
# hp
GRAD_ACC=2
BATCH_SIZE=4
CHUNK_SIZE=8
