...
CKPT="${BASE_PATH}/results/tinyllama2/train/alpaca/init/tinyllama2" # directory point to init checkpoint
...
TEACHER_PEFT_CKPT="${BASE_PATH}/results/llama2/train/alpaca/sft/${TEACHER_PEFT_CKPT_NAME}/"
# data
...
# runtime
SAVE_PATH="${BASE_PATH}/results/tinyllama2/train/alpaca/minillm/tinyllama2-13B"
# hp
GRAD_ACC=4
BATCH_SIZE=2
CHUNK_SIZE=8
