...
CKPT="openlm-research/open_llama_3b_v2" # download automatically
PEFT_CKPT_NAME="openllama_random"
PEFT_CKPT="${BASE_PATH}/results/openllama/train/cnn-random/init/e3-bs2-lr0.0005-G4-N2-NN1-lora-16-64-0.1/9186" # directory point to init checkpoint
# teacher
TEACHER_CKPT_NAME="openllama-7b"
TEACHER_CKPT="openlm-research/open_llama_7b_v2"
TEACHER_PEFT_CKPT_NAME="openllama-7b"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/openllama/train/cnn-random/teacher-sft/e5-bs1-lr0.0005-G8-N2-NN1-lora-16-64-0.1/15310"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/cnn-random/prompt/openllama/"
LM_DATA_DIR="${BASE_PATH}/processed_data/minipile/openllama/1024/990K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/openllama/train/cnn-random/minillm"
# hp
GRAD_ACC=8
BATCH_SIZE=1
CHUNK_SIZE=8
