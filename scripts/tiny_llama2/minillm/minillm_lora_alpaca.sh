...
PEFT_CKPT_NAME="tiny_alpaca"
PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/alpaca/init/e3-bs8-lr0.0005-G1-N2-NN1-lora-16-64-0.1/9561"
# teacher
TEACHER_CKPT_NAME="llama2-7B"
TEACHER_CKPT="meta-llama/Llama-2-7b-hf"
TEACHER_PEFT_CKPT_NAME="llama2-7B"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/alpaca/teacher-sft/e5-bs4-lr0.0005-G2-N2-NN1-lora-16-64-0.1/15935"
# data
...
# runtime
SAVE_PATH="${BASE_PATH}/results/tinyllama2/train/alpaca/minillm"
# hp
GRAD_ACC=4
BATCH_SIZE=2
CHUNK_SIZE=8
