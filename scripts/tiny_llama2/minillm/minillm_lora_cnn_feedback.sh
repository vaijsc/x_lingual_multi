...
PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/cnn-feedback/init/e3-bs4-lr0.0005-G2-N1-NN1-lora-16-64-0.1/11760" # directory point to init checkpoint
# teacher
TEACHER_CKPT_NAME="llama2-7B"
TEACHER_CKPT="meta-llama/Llama-2-7b-hf"
TEACHER_PEFT_CKPT_NAME="llama2-7B"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/cnn-feedback/teacher-sft/e5-bs1-lr0.0005-G8-N1-NN1-lora-16-64-0.1/19600"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/cnn-feedback/prompt/tinyllama2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/minipile/tiny_llama2/4096/990K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/tinyllama2/train/cnn-feedback/minillm"
# hp
GRAD_ACC=8
BATCH_SIZE=1
CHUNK_SIZE=2
