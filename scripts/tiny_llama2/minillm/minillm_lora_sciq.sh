...
PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/sciq/init/e3-bs8-lr0.0005-G1-N2-NN1-lora-16-64-0.1/2187" # directory point to init checkpoint
# teacher
TEACHER_CKPT_NAME="llama2-7B"
TEACHER_CKPT="meta-llama/Llama-2-7b-hf"
TEACHER_PEFT_CKPT_NAME="llama2-7B"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/tinyllama2/train/sciq/teacher-sft/e5-bs4-lr0.0005-G2-N2-NN1-lora-16-64-0.1/3645"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/sciq/prompt/tinyllama2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/minipile/tiny_llama2/1024/990K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/tinyllama2/train/sciq/minillm"
# hp
GRAD_ACC=2
BATCH_SIZE=4
CHUNK_SIZE=8
