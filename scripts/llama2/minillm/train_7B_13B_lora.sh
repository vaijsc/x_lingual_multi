...
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly/prompt/llama2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/openwebtext/openllama2/512/9K/"
# runtime
SAVE_PATH="${BASE_PATH}/results/llam2/train/minillm/7B_13B"
# hp
GRAD_ACC=4
BATCH_SIZE=2
CHUNK_SIZE=8
