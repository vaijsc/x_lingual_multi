...
CKPT="${BASE_PATH}/results/gpt2/train/sft/e3-bs8-lr0.0005-G1-N2-NN1/2142"
TEACHER_CKPT_NAME="xlarge-sft"
# TEACHER_CKPT="${BASE_PATH}/results/gpt2/train/sft/gpt2-xlarge/"
TEACHER_CKPT="${BASE_PATH}/results/gpt2/train/sft/e10-bs2-lr5e-05-G1-N2-NN1/28580"
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly/prompt/gpt2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/openwebtext/gpt2/512/9K/"
# runtime
